        ...
        <ul class="navbar-nav mr-auto">
            ...
            <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu" aria-labelledby="dropdown07XL">
                    <a class="dropdown-item" href="profile/${pageContext.request.userPrincipal.name}">Profile</a>
    ...
    <c:if test="${pageContext.request.userPrincipal.name != null}">
        <div class="px-1">
            <div align="center" style="color: cyan">
                <h1 >hi:${objCustomer.firstName}</h1>
            </div>
        </div>
    </c:if>
</nav>
...
<div id="carouselExampleCaptions" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner">
        <div class="carousel-item active">
            <img src="https://images.unsplash.com/photo-1613305159023-3edb825a998a?ixid=MXwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHw%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=889&q=80" class=" w-100 " alt="Error loading image">
            <div class="carousel-caption d-none d-md-block">
                <h3>We design your dream space into a reality!</h3>
            </div>
        </div>
        <div class="carousel-item">
            <img src="https://images.unsplash.com/photo-1509057199576-632a47484ece?ixlib=rb-1.2.1&ixid=MXwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHw%3D&auto=format&fit=crop&w=751&q=80" class="d-block w-100" alt="Error loading image">
            <div class="carousel-caption d-none d-md-block">
                <h3>Elegance & luxurious appeal with highest quality of materiel!</h3>
            </div>
        </div>
        <div class="carousel-item">
            <img src="https://images.unsplash.com/photo-1518373714866-3f1478910cc0?ixlib=rb-1.2.1&ixid=MXwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHw%3D&auto=format&fit=crop&w=750&q=80" class="d-block w-100" alt="Error loading image">
            <div class="carousel-caption d-none d-md-block">
...
<center>
        <c:forEach var="object" items="${restObject}">
                  <div class="container"  style="background-image: url('https://wallpapercave.com/wp/g0c4dxk.jpg');width: 200px">
                        <%--heare i am passing bookid by using queryString and accessing in controller by using @RequestParam--%>
                     <p>BOOK_ID:</p><a href="getBookById?bookId=${object.bookId}">${object.bookId}</a><br>
                        <%--hear i am passing bookid by using queryString and accessing in controller by using @RequestParam--%>
                     <P>BookName:</P><a href="getBookById?bookId=${object.bookId}">${object.bookName}</a><br>
                            <P>BookAuther:</P>${object.bookAuthor}<br>
                            <P>BookPrice:</P>${object.bookPrice}<br>
                    ...
                    <P>BUY BOOK:</P><a href="${Buy}">BUY</a><br>
                    <hr>
                  </div>
        </c:forEach>
</center>
